...
<?php
    ...
    $user = $_SESSION['user'];
          ...
          $conexion=conexion();
    $sql="SELECT rol FROM login_users WHERE login_users.usuario = '$user'";
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                  ...
                  <li class="nav-item active">
                    <a class="nav-link" disabled>Usuarios <span class="sr-only">(current)</span></a>
                  </li>
                  
                  <li class="nav-item active">
                    <a class="nav-link btn btn-outline-info btn-sm" href="../login_create/register.php" title="Agregar Usuarios">
                      <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-person-plus" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" d="M8 5a2 2 0 1 1-4 0 2 2 0 0 1 4 0zM6 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm6 5c0 1-1 1-1 1H1s-1 0-1-1 1-4 6-4 6 3 6 4zm-1-.004c-.001-.246-.154-.986-.832-1.664C9.516 10.68 8.289 10 6 10c-2.29 0-3.516.68-4.168 1.332-.678.678-.83 1.418-.832 1.664h10zM13.5 5a.5.5 0 0 1 .5.5V7h1.5a.5.5 0 0 1 0 1H14v1.5a.5.5 0 0 1-1 0V8h-1.5a.5.5 0 0 1 0-1H13V5.5a.5.5 0 0 1 .5-.5z"/>
                      </svg></a>
                  </li>
                  <li class="nav-item active">
                    <a class="nav-link btn btn-outline-info btn-sm" href="../login_create/edit.php" title="Editar Usuarios">
                  ...
                  <li class="nav-item active">
                    <a class="nav-link" href="../menus/crear_reporte.php">
                  ...
                  <?php if($ver[0] == 1){ ?>
                  <li class="nav-item active">
                    <a class="nav-link" href="../menus/control.php" tabindex="-1" aria-disabled="true">
