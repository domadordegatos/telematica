...
<?php
      session_start();
      if (isset($_SESSION['temp_058'])):
        foreach (@$_SESSION['temp_058'] as $key) {
        $dat=explode("||", $key);
       ?>
       <tr>
        ...
        <th><a class="btn btn-sm <?php if($dat[4] == 2){ echo 'btn-danger'; }else{ echo 'btn-warning'; }?>" onclick="desactivar_058('<?php echo $dat[0]; ?>')">
