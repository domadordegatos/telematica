...
<?php
      session_start();
      if (isset($_SESSION['temp_037'])):
        foreach (@$_SESSION['temp_037'] as $key) {
        $dat=explode("||", $key);
       ?>
       <tr>
        ...
        <th><a class="btn btn-sm <?php if($dat[4] == 2){ echo 'btn-danger'; }else{ echo 'btn-warning'; }?>" onclick="desactivar_037('<?php echo $dat[0]; ?>')">
