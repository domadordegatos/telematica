...
<?php
      session_start();
      if (isset($_SESSION['temp_065'])):
        foreach (@$_SESSION['temp_065'] as $key) {
        $dat=explode("||", $key);
       ?>
       <tr>
        ...
        <th><a class="btn btn-sm <?php if($dat[4] == 2){ echo 'btn-danger'; }else{ echo 'btn-warning'; }?>" onclick="desactivar_065('<?php echo $dat[0]; ?>')">
