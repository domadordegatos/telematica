...
<?php
      session_start();
      if (isset($_SESSION['temp_002'])):
        foreach (@$_SESSION['temp_002'] as $key) {
        $dat=explode("||", $key);
       ?>
       <tr>
        ...
        <th><a class="btn btn-sm <?php if($dat[4] == 2){ echo 'btn-danger'; }else{ echo 'btn-warning'; }?>" onclick="desactivar_002('<?php echo $dat[0]; ?>')">
