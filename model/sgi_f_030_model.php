<?php
    ...
    class sgi_f_030_controller{
        ...
        function agregar_formato (){
                ...
                $e4=$_POST['form16'];   $g4=$_POST['form39'];  $h4=$_POST['form50']; 
                $e5=$_POST['form17'];   $f5=$_POST['form28'];  $g5=$_POST['form40'];  $h5=$_POST['form51']; 
               ...
               $d12=$_POST['form12'];  
                ...
                $sql="INSERT INTO sgi_f_030 (id_030_principal,actividad,fecha,inspector,hallazgos,fecha_cierre,estado) VALUES ('','$d1','$d2','$d3','$h12','$h13','1')";
